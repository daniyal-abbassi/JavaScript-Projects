...
const { team, sport, year, isWorldCupWinner, players } = myFavoriteFootballTeam;
...
const setPlayerCard = (arry = players) => {
    playerCards.innerHTML += arry.map(({ name, position, number, isCaptain, nickname }) => {
        return `
